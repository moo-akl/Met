    ...
    <div className="min-h-screen bg-background overflow-hidden selection:bg-primary/20 selection:text-primary-foreground">
      ...
      <nav className="fixed top-0 inset-x-0 z-50 bg-white/60 backdrop-blur-md border-b border-white/20">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <button className="bg-gray-900 text-white px-5 py-2 rounded-full text-sm font-semibold hover:bg-green-600 transition-colors duration-300">
            Get the App
          </button>
        </div>
      </nav>
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10 flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
              <button className="w-full sm:w-auto bg-gray-900 hover:bg-black text-white px-8 py-4 rounded-full font-bold text-base shadow-xl shadow-gray-900/20 hover:scale-105 transition-all duration-300">
                Download Met — Free
              </button>
      ...
      <section className="py-32 bg-hero-gradient relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10 text-center">
          ...
          >
            ...
            <button className="bg-gray-900 hover:bg-black text-white px-10 py-5 rounded-full font-bold text-lg shadow-2xl shadow-gray-900/20 hover:scale-105 transition-all duration-300">
              Download Met for Free
            </button>
          </motion.div>
        </div>
      </section>
