...
export const en = {
  ...
  onboarding: {
    ...
    venueOwnerCta: "I own or manage a venue",
    venueOwnerCtaSub: "Create an account to register your venue with Met.",
  ...
  paywall: {
    ...
    perkOpenersSub: "Break the ice — Plus gets 5/day, Pro gets unlimited.",
    ...
    heroSubPlus: "Unlimited reveals, 5 daily openers, and your verified badge.",
    heroTitlePro:
    ...
    featureOpeningsPlus: "5 / day",
    featureOpeningsPro: "Unlimited",
    featureHistoryLabel: "Encounter history",
  ...
  settings: {
    ...
    registerVenueSub: "Promote your venue, events, and rewards",
  ...
  subscription: {
    ...
    proPrice: "$4.99 / mo",
    popular: "Popular",
    featureUnlimitedViews: "See who viewed your profile",
    featurePlusBadge: "Verified badge, read receipts & privacy mode",
    featureEncounters: "Unlimited encounters & reveals",
    featureRadarSpotlight: "Boost — rank higher at venues",
    featureProBadge: "Unlimited openers & gold badge",
    featureOpeners5Day: "5 opening messages per day",
    featureHistory30: "30-day encounter history",
