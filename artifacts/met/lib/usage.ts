...
//
// Free tier: 6 reveals per day.
// Plus tier: 5 opening messages per day.
// Pro tier:  unlimited opening messages (Infinity bypasses the cap check).
//
...
export const FREE_HISTORY_ENCOUNTERS = 3;
