/**
 * Server-side interest label translations.
 *
 ...
 * This module provides a locale-aware lookup so server-generated copy (e.g.
 * push notification bodies) can surface the label in the recipient's language.
 *
 * Keep in sync with `artifacts/met/lib/i18n/locales/*.ts` interestLabels sections.
 */
...
type InterestLabels = Record<InterestKey, string>;

const labels: Record<string, InterestLabels> = {
  en: {
